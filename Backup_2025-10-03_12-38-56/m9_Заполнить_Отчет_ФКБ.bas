...
'    If MsgBox("Как бэ сегодня папок со сканами = " & КоличСканов & " Открыть файл Отчёта?", vbYesNo) <> vbYes Then Exit Sub
    ...
    fl = IsBookOpen("C:\Users\Хозяин\Desktop\Отчет по клаймам за май 2025.xlsx")
        ...
        Else
            Set wBook = Workbooks.Open(FileName:="C:\Users\Хозяин\Desktop\Отчет по клаймам за май 2025.xlsx")  ' открыл
        End If
