...
Public Sub ВсеБэкапы(control As IRibbonControl)
    Call БэкапЭтойКниги(Nothing)
    Call БэкапДинамики_2026(Nothing)
    Call БэкапНадстроки(Nothing)
...
'    MsgBox "Бэкап создан", vbInformation
    ...
    MsgBox "Бэкапы активной книги созданы в двух локациях: C:\Users\s.lazarev\Desktop\БЭКАПЫ и Q:\Corporative\ОСВ\ОБМЕННИК\Фабрика\отдел архива длительного хранения\архив\Лазарев\Backups\Рабочие книги", vbInformation
End Sub
...
Sub БэкапДинамики_2026(control As IRibbonControl)
'Sub БэкапДинамики_2026()
    Dim fso As Object
    Set fso = CreateObject("Scripting.FileSystemObject")
    SourceFile = "Q:\Corporative\ОСВ\ОБМЕННИК\Фабрика\отдел архива длительного хранения\архив\Динамика\Динамика 2026 Электрозаводская.xlsx"
    destFolder = "C:\Users\s.lazarev\Documents\BackupДинамика\" & "Динамика 2026 Электрозаводская " & " (Backup) " & Format(Now(), "yyyy-mm-dd hh-mm-ss") & ".xlsx"
    ' создать целевую папку, если её ещё нет
If Not fso.FolderExists("C:\Users\s.lazarev\Documents\BackupДинамика\") Then _
    fso.CreateFolder "C:\Users\s.lazarev\Documents\BackupДинамика\"
    fso.CopyFile SourceFile, destFolder
     MsgBox "Резервная копия создана:" & vbCrLf & destFolder, vbInformation
End Sub
...
Sub БэкапНадстроки_На_Q()
    ...
    fso.CopyFile SourceFile, destFolder
    MsgBox "СОЗДАН" & _
    vbNewLine & "бэкап Надстройки2" & _
    vbNewLine & "на диске Q \архив\Лазарев\Backups\Backap_AddIns", vbInformation
End Sub
