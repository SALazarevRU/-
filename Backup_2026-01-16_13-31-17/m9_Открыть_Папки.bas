...
Sub ќткрытьѕапку—лива—канов√ѕЅЌаQ(control As IRibbonControl)
    Dim myFolder As String
    myFolder = "Q:\LP2\–езультаты сверки портфелей с августа 2020\√азпром √ѕЅ 2\сканы 17.11"
    shell "explorer.exe """ & myFolder & """", vbNormalFocus
End Sub
...
Sub ќткрытьѕапку–абочий—тол(control As IRibbonControl)
    Dim myFolder As String
    myFolder = "C:\Users\s.lazarev\Desktop\√ѕЅ_—верка_и_сканирование_16.07.2025\— јЌџ_в_работе"
    shell "explorer.exe """ & myFolder & """", vbNormalFocus
End Sub
