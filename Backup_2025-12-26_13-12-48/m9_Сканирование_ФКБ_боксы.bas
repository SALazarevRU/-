...
Public Sub ¬рем€—канировани€‘ Ѕ(editBox As IRibbonControl, text As Variant)   ' ѕри заполнении в €чейке мен€етс€ в боксе!
     Dim ¬рем€—канировани€‘ Ѕ  As Long
    ¬рем€—канировани€‘ Ѕ = Worksheets("ппон‘ Ѕ").Range("D41")
    text = "   " & ¬рем€—канировани€‘ Ѕ & " секунд"
End Sub
...
Public Sub «апасы‘айлов‘ Ѕ(editBox As IRibbonControl, text As Variant)   ' «апасы ‘айлов ‘ Ѕ
     Dim «апасы‘айлов‘ Ѕ  As Variant
    «апасы‘айлов‘ Ѕ = Worksheets("ппон‘ Ѕ").Range("D52")
    text = "   " & «апасы‘айлов‘ Ѕ
End Sub
...
Public Sub «апасы—клад‘ Ѕ(editBox As IRibbonControl, text As Variant)   ' «апасы ѕапок ‘ Ѕ
     Dim «апасы—клад‘ Ѕ  As Variant
    «апасы—клад‘ Ѕ = Worksheets("ппон‘ Ѕ").Range("D56")
    text = "   " & «апасы—клад‘ Ѕ
End Sub
