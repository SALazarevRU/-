...
'   Sub CopyFoldersWithFilesГПБ() 'Копирование папок с файлами
    ...
    If MsgBox("Целевая папка Q:\LP2\Результаты сверки портфелей с августа 2020\Газпром ГПБ 2\сканы 10.09 ?", vbYesNo, "Имя приложения: " & Application.Name) = vbNo Then Exit Sub
